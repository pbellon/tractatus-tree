angular.module('tractatusTree').directive('tractatusGraph', [
    function(scope, element, attr){
        var directive = {
            ...
            link: function(scope, elem, attr){
                console.log('tractatusGraph.link');
                ...
                var update = function(){
                    ...
                    d3.json('file:///home/toutenrab/Dev/D3-tractatus/app/data/tractatus.json', function(error, root){
